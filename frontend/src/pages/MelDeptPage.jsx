...
export default function MelDeptPage() {
  ...
  const stats = [
    { icon:"📄", target:10,  label:"Research Papers",     g:"linear-gradient(135deg,#ff00ff,#00f0ff)" },
    { icon:"👥", target:25,  label:"Faculty Members",      g:"linear-gradient(135deg,#00f0ff,#3b00ff)", d:"0.1s" },
    { icon:"🎓", target:200, label:"Students Placed",      g:"linear-gradient(135deg,#ffd700,#ff00ff)", d:"0.2s" },
    { icon:"🏆", target:100, label:"Student Achievements", g:"linear-gradient(135deg,#3b00ff,#ff00ff)", d:"0.3s" },
  ];
  ...
  const faculty  = [{ i:"M", g:"linear-gradient(135deg,#ff00ff,#3b00ff)", name:"Dr. Monika Puttaramaiah" },{ i:"S", g:"linear-gradient(135deg,#00f0ff,#3b00ff)", name:"Soniya L" }];
      ...
      <div style={S.page}>
        ...
        <section id="research" style={S.section()}>
          ...
          <div style={S.researchGrid}>
            {[
              { icon:"🧠", title:"Machine Learning",           desc:"Building intelligent models that learn from data. Developing novel algorithms, deep neural networks, and scalable training frameworks for real-world impact.",                                                                                  ibg:"rgba(255,0,255,0.12)",  ib:"rgba(255,0,255,0.25)",  ac:"#ff00ff" },
              { icon:"👁",  title:"Computer Vision",            desc:"Teaching machines to see and interpret the visual world. From object detection to semantic understanding and beyond using state-of-the-art architectures.",                                                                                       ibg:"rgba(0,240,255,0.12)",  ib:"rgba(0,240,255,0.25)",  ac:"#00f0ff", d:"0.15s" },
